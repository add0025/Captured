...
local promptText = "Searching throught the basement you see a large brick door with a a number pad right next to it... and torture contraptions all around you... 'We have got to get out of here...' You think.  But just as you have that thought You here The basement door crack open and Cerial appears fury in his eyes. He screams at the top of his lungs I AM GOING TO KILL YOU BOTH! Thre's no time for delay."
local choiceText1 = "This man is pathetic. Fight back and defend yourself!"
...
--if (inventory:has("seenWall")) then
   local choiceText3 = "The door the keypad. the pattern Kimberly mentioned. Maybe if I type it in it'll open the door and we will be out of here!"
...
local function optionSelect3(event) 
   ...
   audio.play(ping)
   local options = { params = { inv = inventory, hostage = false } }
...
function scene:create( event )
   ...
   local button3 = widget.newButton( { left = -75, top = 210, id = "button_1", width = 480, height = 480, defaultFile = "captured_5.png", overFile = "captured_5.png",  onEvent = handleButtonEvent} )
   ...
   local button1 = widget.newButton( { left = -75, top = 30, id = "button_3", width = 480, height = 480, defaultFile = "captured_5.png", overFile = "captured_5.png",  onEvent = handleButtonEvent} )
