...
local promptText = "'I have no idea. One day I was just taking my daily morning stroll in Ashberry park, the next day I wake up dizzy in this tiny little room.....?'"
local choiceText1 = "Sounds similar to how you arrived at this strange place. Maybe if you ask more questions you can get more information on exactly how you got here and who SHE is."
...
local function optionSelect1(event) 
   ...
   composer.gotoScene("Scene11b", options)
...
local function optionSelect2(event) 
   ...
   audio.play(ping)
   local options = { params = { inv = inventory } }
   composer.gotoScene("Scene12b", options)
