...
local promptText = "Great! You have found a knife. As you walk through the hallways you here a low, sad, eerie whimper."
local choiceText1 = "Ignore it. It might be a trap."
local choiceText2 = "Walk towards the noise. It could be another victim in need."
...
local function optionSelect2(event) 
   ...
   audio.play(ping)
   local options = { params = { inv = inventory } }
   composer.gotoScene("Scene6b", options)
