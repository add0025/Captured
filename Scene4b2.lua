...
local promptText = "Yippee! You have found a key along with a razor in a hidden shoe box. You quickly rip the duct tape off and cut off the rope. Now time for your escape!"
...
function scene:create( event )
   ...
   inventory:addItem("razor")

   inventory:setFlag("4b2")
   inventory:flagSave()
