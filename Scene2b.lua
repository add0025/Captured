...
local promptText = "'Silly you.' the man responds. 'You are exactly who I wanted. Now stay put.' Cerial briefly turns from your gaze..."
local choiceText1 = "Try and reason again. There must be some heart left in this man."
local choiceText2 = "Quick! Run through the door while he's turned around."
local choiceText3 = "Stay put. You have to start thinking stuff out, and try not to do anything drastic."
...
local function optionSelect1(event) 
   ...
   composer.gotoScene("Scene3a", options)
...
local function optionSelect3(event) 
   ...
   audio.play(ping)
   local options = { params = { inv = inventory } }
   composer.gotoScene("Scene3b", options)
