...
local promptText = "You wake up dizzy and exhausted. Where are you? Who is that man in the distance, and why is he grinning at you?"
local choiceText1 = "Scream! There must be someone nearby."
local choiceText2 = "Demand your release. Who does this guy think he is?"
local choiceText3 = "Reason with the man and ask him to let you go. Maybe he has mistaken you for someone else."
...
function scene:show( event )
   ...
   elseif ( phase == "did" ) then
      ...
      local bgm = audio.loadStream("bgm.wav")
      audio.play(bgm, {channel = 2, loops = -1})
